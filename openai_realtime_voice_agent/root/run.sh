...
HOMEPOD_EARLY_RETURN_GRACE_SECONDS=$(bashio::config 'homepod_early_return_grace_seconds')
...
export HOMEPOD_EARLY_RETURN_GRACE_SECONDS
...
# mc13 imports the complete validated mc12->mc11->mc10->mc9 stack, then adds the
# local proactive Gmail bridge used by Home Assistant to arm a Voice PE follow-up
# without relying on the stock assist_satellite pipeline.
export PYTHONUNBUFFERED=1
exec python3 -c 'import app.mc13_patch; import runpy; runpy.run_module("app.main", run_name="__main__")'
